          ...
          <div className="source-body">
            ...
            <p>
              {municipality.slug === 'catano'
                ? lang === 'en'
                  ? 'Cataño includes the two shelters designated in PRDOH’s 2026 list. Coordinates come from the places linked in that list and are not field verified. Other facility categories have not yet been inventoried. Current operation, capacity and safe access remain unconfirmed.'
                  : 'Cataño incluye dos refugios designados por Vivienda en 2026. Las coordenadas provienen de los lugares enlazados en esa lista y no están verificadas en campo. Otras categorías no se han inventariado. Operación, capacidad y acceso seguro siguen sin confirmar.'
                : lang === 'en'
